...
- [implementation-plan.md](/plan/implementation-plan.md): roadmap triển khai từ repo trống tới MVP playable, gồm phase, deliverables, test gates và acceptance criteria.
...
- `implementation-plan.md` biến toàn bộ các docs trên thành thứ tự triển khai cụ thể để bắt đầu code.
