...
- [game-design.md](/home/thuantruong/03_Boardgame/plan/game-design.md): vision sản phẩm, trải nghiệm người chơi, phạm vi MVP, luật ở mức gameplay.
- [functional-spec.md](/home/thuantruong/03_Boardgame/plan/functional-spec.md): đặc tả tính năng theo hành vi người dùng và luồng hệ thống.
- [game-engine-spec.md](/home/thuantruong/03_Boardgame/plan/game-engine-spec.md): đặc tả state server-authoritative, luật resolve, validation và hidden information.
- [technical-design.md](/home/thuantruong/03_Boardgame/plan/technical-design.md): kiến trúc hệ thống, socket contract, reconnect strategy và định hướng scale.
